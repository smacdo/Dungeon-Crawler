...
namespace Scott.Forge.Spatial
{
    ...
    ///  TODO: Unit testing!
    /// </remarks>
    public class SpatialIndex<TObject> where TObject : new()
    {
        ...
        {
            private readonly SpatialIndex<TObject> mSpatial;
            private readonly BoundingRect mQueryBounds;
            private readonly TObject mExcludes;
            
            public QueryResult(SpatialIndex<TObject> spatial, BoundingRect bounds, TObject excludes)
            {
                mSpatial = spatial;
                mQueryBounds = bounds;
                mExcludes = excludes;
        ...
        public struct QueryEnumerator
        {
            ...
            public QueryEnumerator(SpatialIndex<TObject> spatial, BoundingRect bounds, TObject excludes)
            {
                mSpatial = spatial;
                mQueryBounds = bounds;
                mExcludes = excludes;
