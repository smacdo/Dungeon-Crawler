...
namespace Scott.Forge.Engine.Graphics
{
    ...
    public class DebugRenderer
    {
        ...
        [Conditional("DEBUG")]
        public void DrawRect(RectF dimensions)
        {
            DrawRect(dimensions.ToXnaRectangle(), Color.HotPink);
        }
        ...
        [Conditional( "DEBUG" )]
        public void DrawFilledRect( RectF dimensions, Color color )
        {
            DebugRectangle r = FindNextUnused<DebugRectangle>( mRectsToDraw );
        ...
        class DebugLine : DebugPrimitive
        {
            ...
            public override void Draw( SpriteBatch spriteBatch, Texture2D pixel, SpriteFont font )
            {
                ...
                spriteBatch.Draw(
                    ...
                    angle,
                    Microsoft.Xna.Framework.Vector2.Zero,
                    new Microsoft.Xna.Framework.Vector2( length, Width ),
                    SpriteEffects.None,
                    0 );
            }
        }
        ...
        class DebugText : DebugPrimitive
        {
            ...
            public override void Draw( SpriteBatch spriteBatch, Texture2D pixel, SpriteFont font )
            {
                ...
                spriteBatch.DrawString(font, Text, Position.ToXnaVector2(), Color);
            }
        }
    }
}
