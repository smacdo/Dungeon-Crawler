...
namespace Scott.Game.State
{
    ...
    /// </summary>
    public class GameStateManager : IUpdatable, IDrawable, IDisposable
    {
        const int DEFAULT_MAX_STACK_COUNT = 16;
        private List<GameState> mStates = new List<GameState>( DEFAULT_MAX_STACK_COUNT );
